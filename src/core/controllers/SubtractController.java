...
import core.models.operators.Substraction;
...
public class SubtractController {
    public static Response subtractNumbers(String number1, String number2) {
        try{
            double num1, num2;
            String[] decimales;
            if (number1.isEmpty()) {
            ...
            String result = String.format("%.3f",Calculator.calculate(new Substraction(), num1, num2));
